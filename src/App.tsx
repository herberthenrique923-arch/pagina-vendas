    ...
    <div className="fixed inset-0 z-[200] flex items-start justify-center overflow-y-auto bg-stone-900/60 p-4 backdrop-blur-sm sm:items-center">
      ...
      >
        ...
        <div className="mb-8 space-y-3 text-left">
          ...
          <a 
            href="https://pay.wiapy.com/dVQJ2qZ4UB"
            target="_blank"
            rel="noopener noreferrer"
            className="flex w-full items-center justify-center gap-2 rounded-2xl bg-[#10b981] py-4 text-[13px] font-black text-white shadow-lg shadow-emerald-100 transition-all hover:bg-[#059669] active:scale-95"
          >
            <ShoppingCart className="h-4 w-4" />
            QUERO COMPRAR O PREMIUM POR R$17
          </a>
          <a 
            href="https://pay.wiapy.com/odzZUHCSRl"
            target="_blank"
            rel="noopener noreferrer"
            className="block w-full rounded-2xl border border-stone-200 bg-white py-4 text-center text-sm font-bold text-stone-400 transition-all hover:bg-stone-50 active:scale-95"
          >
      ...
      <header className="relative px-4 pt-8 pb-8 text-center md:px-6 md:pt-16">
        ...
        >
          ...
          <p className="mx-auto mb-8 max-w-xl text-sm font-medium leading-relaxed text-stone-500 md:mb-10 md:text-lg">
            50 atividades simples e práticas para lidar com crises emocionais e sensoriais no autismo — <span className="font-bold text-stone-800">sem grito, sem culpa e sem precisar de preparo</span>
          </p>

          {/* Hero Image Card */}
          <div className="mx-auto max-w-[280px] overflow-hidden rounded-[2rem] bg-[#fef3c7] p-1.5 shadow-2xl shadow-stone-200 md:max-w-sm md:rounded-[2.5rem] md:p-2">
            <div className="relative aspect-square w-full overflow-hidden rounded-[1.75rem] md:rounded-[2rem]">
              <img 
                src="https://image2url.com/r2/default/images/1774538329623-2ecdf252-365d-4d3a-ad98-d41fb0b2b8bb.png" 
                alt="50 Atividades Práticas para Crianças com Autismo" 
                className="h-full w-full object-contain"
                referrerPolicy="no-referrer"
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  target.src = "https://picsum.photos/seed/autism-activities/600/800";
                }}
              />
            </div>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 md:gap-8">
            {[
              ...
              <div key={i} className="flex flex-col items-center rounded-[2rem] border-2 border-emerald-100 bg-[#f0fdf4]/30 p-6 text-center shadow-xl shadow-emerald-50 transition-all hover:scale-[1.02] md:rounded-[2.5rem] md:p-10">
                ...
                <p className="relative mb-3 inline-block text-lg font-black text-red-500 md:mb-4 md:text-xl">
                  {item.price}
                  <span className="absolute left-0 top-1/2 h-[2px] w-full -rotate-12 bg-red-500"></span>
                </p>
                <p className="text-sm leading-relaxed text-stone-500 md:text-base">{item.desc}</p>
              </div>
            ))}
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="flex flex-col rounded-[2rem] border-2 border-blue-500 bg-white p-6 shadow-2xl shadow-stone-100 md:rounded-[2.5rem] md:p-10">
              ...
              <button 
                ...
                className="flex w-full items-center justify-center gap-2 rounded-full bg-[#10b981] py-4 text-[13px] font-black text-white shadow-xl transition-all hover:scale-105 hover:bg-[#059669] active:scale-95 md:py-5 md:text-lg"
              >
                <ShoppingCart className="h-5 w-5 md:h-6 md:w-6" />
                <span className="whitespace-nowrap">QUERO COMPRAR O BÁSICO</span>
              </button>
            </div>
            ...
            <div className="relative flex flex-col rounded-[2rem] border-2 border-blue-500 bg-white p-6 shadow-2xl shadow-blue-50 md:rounded-[2.5rem] md:p-10">
              ...
              >
                <ShoppingCart className="h-5 w-5 md:h-6 md:w-6" />
                <span className="whitespace-nowrap">QUERO COMPRAR O PREMIUM</span>
              </a>
            </div>
          </div>
        </div>
            ...
            {[
              ...
              <div key={i} className="flex flex-col rounded-[1.5rem] border border-stone-50 bg-white p-6 shadow-2xl shadow-stone-100 md:rounded-[2.5rem] md:p-8">
                ...
                <div className="mt-auto flex items-center gap-4">
                  <img src={item.img} alt={item.name} className="h-10 w-10 rounded-full object-cover ring-2 ring-blue-100 md:h-12 md:w-12" />
                  <div>
