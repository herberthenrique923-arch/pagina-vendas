      ...
      >
        ...
        <div className="space-y-3">
          <a 
            ...
            className="block w-full rounded-2xl bg-[#10b981] py-4 text-sm font-black text-white shadow-lg shadow-emerald-100 transition-all hover:bg-[#059669] active:scale-95"
          >
